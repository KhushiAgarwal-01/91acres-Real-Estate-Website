        ...
        <div className='bg-white shadow-1 pb-5 rounded-lg  w-full max-w-[300px] mx-auto cursor-pointer hover:shadow-2xl transition text-gray-600'>
            ...
            <div className='p-3'>
                <div className='flex justify-between items-center px-3'>
                    <div className='text-lg  text-gray-800 mb-4 font-bold pl-2' >${price} <span className='text-gray-500 font-light text-sm'>/month</span> </div>
                ...
                <div className='flex justify-around my-1 p-1 border-t-2 ' >
                    <div className='flex items-center gap-1'>
                        <div className='text-[20px] text-gray-700' ><BiBed/> </div>
                        <div >{bedrooms}</div>
                    </div>
                    <div className='flex items-center gap-1'>
                        <div className='text-[20px] text-gray-700' ><BiBath/> </div>
                        <div >{bathrooms}</div>
                    </div>
                    <div className='flex items-center gap-1'>
                        <div className='text-[20px] text-gray-700' ><BiArea/> </div>
                        <div >{surface}</div>
                    </div>
                </div>
            </div>
